...
const AllProducts = () => {
  ...
  useEffect(() => {
    const fetchAllProducts = async () => {
      try {
        setLoading(true);
        console.log('Fetching all products from: http://localhost:5000/api/products/all');
        // Fetch all products
    ...
    fetchAllProducts();
  }, []); // Removed the 'all' dependency which was causing issues
    ...
    <div className="flex flex-col h-screen">
      ...
      <Navbar />
        ...
        <div className="container mx-auto px-4 mt-10">
          <h1 className="text-3xl font-bold mb-8 text-center mt-30">All Jewellery Collection</h1>
