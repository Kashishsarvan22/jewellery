  ...
  useEffect(() => {
    const fetchJewelrySets = async () => {
      ...
      try {
        ...
        const url = `http://192.168.29.85:5000/products/type/jewelry sets${
    ...
    <div className="px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {products.map((product) => (
          ...
          >
            <img src={`http://192.168.29.85:5000${product.image}`} alt={product.name} className="w-full h-full object-cover rounded-md mb-4" />
